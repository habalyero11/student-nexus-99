...
// Define Types locally since we had issues with Database imports in other files
...
const EnhancedGradeForm = ({ students, initialStudentId, onSuccess, onCancel }: EnhancedGradeFormProps) => {
  const [formData, setFormData] = useState<Grade>({
    student_id: initialStudentId || (students.length === 1 ? students[0].id : ""),
    subject: "",
    quarter: "1st",
    written_work: null,
